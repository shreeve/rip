// Jison, an LALR(1) Parser Generator
...
generator.computeLookaheads = function computeLookaheads () {
...
generator.followSets = function followSets () {
    ...
    while(cont) {
        ...
        for (symbol in nonterminals) {
            ...
            nonterminals[symbol].productions.forEach(function (production) {
                unionArrays(firsts, production.first);
            });
...
generator.generateModuleExpr = function generateModuleExpr () {
    var out = "(function(){\n";
    out += "\nvar parser = {";
    out += [
