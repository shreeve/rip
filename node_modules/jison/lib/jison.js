...
// Moved typal.js inline to remove dependency
var typal = (function () {
...
lrGeneratorMixin.ItemSet = class ItemSet {
    constructor() {
        this._items = [];
        this._itemIds = new Set(); // For O(1) duplicate checking
        this.reductions = [];
        this.goes = {};
        this.edges = {};
        this.shifts = false;
    ...
    concat(set) {
        ...
        a.forEach(item => this.push(item));
        return this;
    }

    contains(item) {
        return this._itemIds.has(item.id);
    }
