...
lrGeneratorMixin.Item = class Item {
...
lrGeneratorMixin.ItemSet = class ItemSet {
    constructor() {
...
class LALRGenerator extends Generator {
    constructor(grammar, options) {
        ...
        // Apply mixins
        Object.assign(this, lookaheadMixin, lrGeneratorMixin);
        ...
        var newg = this.newg = Object.assign(Object.create(lookaheadMixin), {
            oldg: this,
            trace: this.trace,
            nterms_: {},
            go_: function (r, B) {
