    ...
    // RHS
        ...
        for (var i=0,t;t=symbol[i];++i) {
            if (!this.nonterminals[t]) {
                ...
                unionArrays(firsts, this.nonterminals[t].first);
            }
            if (!this.nullable(t))
                break;
        }
...
generator.parseTable = function parseTable (itemSets) {
    ...
    const s = 1, r = 2, a = 3; // shift, reduce, accept
    ...
    if (this.conflicts > 0) {
      ...
      throw new Error("Grammar error: " + this.conflicts + " conflict(s) found in grammar." + conflictDetails);
    }
