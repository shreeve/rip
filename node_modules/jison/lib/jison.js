    ...
    while (true) {
        ...
        switch (action[0]) {
            ...
            case 2: // reduce
                ...
                yyval._$ = {
                    first_line: loc[loc.length - (len || 1)].first_line,
                    last_line: loc[loc.length - 1].last_line,
                    first_column: loc[loc.length - (len || 1)].first_column,
                    last_column: loc[loc.length - 1].last_column
                };
                if (ranges) {
                    yyval._$.range = [loc[loc.length - (len || 1)].range[0],
                                      loc[loc.length - 1].range[1]];
                }
                ...
                stk.push(this.productions_[action[1]][0]);
                val.push(yyval.$);
                loc.push(yyval._$);
                newState = table[stk[stk.length - 2]][stk[stk.length - 1]];
                stk.push(newState);
                break;
