// Append elements in b if not already found in a (assumes b and are individually unique)
function union(a, b) {
...
Jison.Parser = (function() {
    ...
    generator.error = function error(msg) {
        ...
        // Generator debug mixin removed

    // LALR(1) Generator - Consolidated class with all functionality
    function LALRGenerator(grammar, options) {
        // Call base constructor
        generator.constructor.call(this, grammar, options);

        this.type = "LALR(1)";

        // Debug mixins removed

        options = options || {};
        this.states = this.canonicalCollection();
        this.terms_ = {};

        var newg = this.newg = Object.create(LALRGenerator.prototype);
        Object.assign(newg, {
            oldg: this,
            trace: this.trace,
            nterms_: {},
    ...
    LALRGenerator.prototype = Object.create(generator);
    LALRGenerator.prototype.constructor = LALRGenerator;

    // === LOOKAHEAD COMPUTATION METHODS ===

    // Main lookahead computation entry point
    LALRGenerator.prototype.computeLookaheads = function computeLookaheads() {
        // Lookahead debug mixin removed
    ...
    LALRGenerator.prototype.followSets = function followSets() {
    ...
    LALRGenerator.prototype.first = function first(symbol) {
        if (symbol === '') {
            return [];
    ...
    LALRGenerator.prototype.firstSets = function firstSets() {
        var productions = this.productions,
            nonterminals = this.nonterminals,
            self = this,
            cont = true,
    ...
    LALRGenerator.prototype.nullableSets = function nullableSets() {
    ...
    LALRGenerator.prototype.nullable = function nullable(symbol) {
        if (symbol === '') {
            return true;
        } else if (symbol instanceof Array) {
            for (var i = 0, t; t = symbol[i]; ++i) {
    ...
    // === LR PARSER GENERATION METHODS ===

    // Main LR table building entry point
    LALRGenerator.prototype.buildTable = function buildTable() {
        // LR generator debug mixin removed
        this.states = this.canonicalCollection();
        this.table = this.parseTable(this.states);
        this.defaultActions = findDefaults(this.table);
    };
    ...
    LALRGenerator.prototype.Item = Item;

    LALRGenerator.prototype.ItemSet = function ItemSet() {
        // Array-like behavior
        this._items = [];
        this.length = 0;
        ...
        // Build hash for existing items
        for (var i = this._items.length - 1; i >= 0; i--) {
            this.hash_[this._items[i].id] = true;
        }
    };

    LALRGenerator.prototype.ItemSet.prototype.concat = function concat(set) {
    ...
    LALRGenerator.prototype.ItemSet.prototype.push = function(item) {
    ...
    LALRGenerator.prototype.ItemSet.prototype.contains = function(item) {
        return this.hash_[item.id];
    };

    LALRGenerator.prototype.ItemSet.prototype.forEach = function(callback) {
        return this._items.forEach(callback);
    };

    LALRGenerator.prototype.ItemSet.prototype.valueOf = function toValue() {
    ...
    // === CORE LR OPERATIONS ===
    LALRGenerator.prototype.closureOperation = function closureOperation(itemSet /*, closureSet*/) {
    ...
    LALRGenerator.prototype.gotoOperation = function gotoOperation(itemSet, symbol) {
    ...
    LALRGenerator.prototype.canonicalCollection = function canonicalCollection() {
    ...
    LALRGenerator.prototype.canonicalCollectionInsert = function canonicalCollectionInsert(symbol, itemSet, states, stateNum) {
    ...
    LALRGenerator.prototype.parseTable = function parseTable(itemSets) {
        var states = [],
            nonterminals = this.nonterminals,
        ...
        if (self.conflicts > 0) {
            ...
            for (var state in conflictedStates) {
                if (conflictedStates.hasOwnProperty(state)) {
                    self.warn('State ' + state);
                    self.warn('  ', itemSets[state].join("\n  "));
                }
            }
        }
    ...
    LALRGenerator.prototype.generate = function parser_generate(opt) {
    ...
    LALRGenerator.prototype.generateCommonJSModule = function generateCommonJSModule(opt) {
        opt = Object.assign({}, this.options, opt);
    ...
    LALRGenerator.prototype.generateModule = function generateModule(opt) {
        opt = Object.assign({}, this.options, opt);
        var moduleName = opt.moduleName || "parser";
        var now = new Date().toISOString();
        var out = "/* parser generated by jison " + version + " on " + now + " */\n";
    ...
    LALRGenerator.prototype.generateModuleExpr = function generateModuleExpr() {
        var out = '';
    ...
    // Token stack support removed - not used by CoffeeScript
    LALRGenerator.prototype.generateModule_ = function generateModule_() {
    ...
    LALRGenerator.prototype.generateTableCode = function(table) {
        ...
        moduleCode = moduleCode.replace(/\{\d+:[^\}]+,\d+:[^\}]+\}/g, function(object) {
            var value, frequentValue, key, keys = {},
                keyCount, maxKeyCount = 0,
                keyValue, keyValues = [],
    ...
    LALRGenerator.prototype.createParser = function createParser() {
    ...
    parser.parseError = LALRGenerator.prototype.parseError = parseError;
    ...
    LALRGenerator.prototype.lookAheads = function LALR_lookaheads(state, item) {
        return (!!this.onDemandLookahead && !state.inadequate) ? this.terminals : item.follows;
    };

    LALRGenerator.prototype.go = function LALR_go(p, w) {
        var q = parseInt(p, 10);
    ...
    LALRGenerator.prototype.goPath = function LALR_goPath(p, w) {
        var q = parseInt(p, 10),
            t,
            path = [];
        for (var i = 0; i < w.length; i++) {
    ...
    LALRGenerator.prototype.buildNewGrammar = function LALR_buildNewGrammar() {
        var self = this,
            newg = this.newg;
    ...
    LALRGenerator.prototype.unionLookaheads = function LALR_unionLookaheads() {
        var self = this,
            newg = this.newg,
    ...
    // LALR generator debug mixin removed
