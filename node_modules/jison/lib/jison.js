...
// Ultra-minimal Set implementation - only what Jison actually uses
var setMixin = {
    ...
    // Core methods actually used by Jison
    ...
    item: function item (v) { return this._items[v]; },
    ...
    // Array methods used by Jison
    push: function push() { return this._items.push.apply(this._items, arguments); },
    forEach: function forEach() { return this._items.forEach.apply(this._items, arguments); }
};
