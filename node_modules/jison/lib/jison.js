...
Jison.Parser = (function() {
    ...
    // Lookahead Mixin - Provides lookahead computation functionality
    // Used by parsers that need to compute FIRST, FOLLOW, and nullable sets
    var lookaheadMixin = {};
    ...
    // LR Generator Mixin - Provides LR parser generation functionality
    // Used by LALR and other LR-based parsers for table construction and parsing
    ...
    lrGeneratorMixin.Item = Item;

    lrGeneratorMixin.ItemSet = function ItemSet() {
        // Array-like behavior
        this._items = [];
        this.length = 0;
    ...
    lrGeneratorMixin.ItemSet.prototype.concat = function concat(set) {
    ...
    lrGeneratorMixin.ItemSet.prototype.push = function(item) {
    ...
    lrGeneratorMixin.ItemSet.prototype.contains = function(item) {
        return this.hash_[item.id];
    };

    lrGeneratorMixin.ItemSet.prototype.forEach = function(callback) {
        return this._items.forEach(callback);
    };

    lrGeneratorMixin.ItemSet.prototype.valueOf = function toValue() {
    ...
    function LALRGenerator(grammar, options) {
        ...
        var newg = this.newg = Object.create(lookaheadMixin);
        Object.assign(newg, {
            oldg: this,
            trace: this.trace,
            nterms_: {},
    ...
    // Set up prototype chain: LALRGenerator inherits from generator and mixins
    // This creates a proper ES5 class structure while maintaining mixin functionality
    LALRGenerator.prototype = Object.create(generator);
    Object.assign(LALRGenerator.prototype, lookaheadMixin, lrGeneratorMixin);
