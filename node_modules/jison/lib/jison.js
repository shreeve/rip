...
class BaseGenerator {
  ...
  generateModule(opt) {
    ...
    const moduleDeclaration = moduleName.match(/\./) ? moduleName : `var ${moduleName}`;
    return `/* parser generated by rip-parser ${version} */
${moduleDeclaration} = ${this.generateModuleExpr()}`;
  }
...
// LALRGenerator extends BaseGenerator for generating LALR(1) parsers
class LALRGenerator extends BaseGenerator {
  constructor(grammar, options) {
    ...
    var newg = this.newg = Object.assign(Object.create(BaseGenerator.prototype), {
      oldg: this,
      trace: this.trace,
      nterms_: {},
      go_: function (r, B) {
...
module.exports = { Parser: LALRGenerator };
