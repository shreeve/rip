# Browser / src size baseline — BEFORE

Captured: 2026-08-07T20:18:24.860Z
...
|------|----:|------:|----:|--------:|----------:|--------:|-----:|
| dist/rip.js | 1501.9 | 1501.4 | 965.9 | 194.2 | 194.1 | 161.7 | 0% |
| emitter.js | 706.2 | 519.5 | 255.4 | 155.0 | 97.9 | 56.9 | 26% |
...
## Committed artifacts at branch start

Before the bundle script emitted min/br, only `dist/browser/rip.js` was committed:

| File | raw KB |
|------|-------:|
| dist/browser/rip.js | 1501.9 |

After the first successful three-artifact emit, see `SIZES.artifacts.md`.
