...
//
// Started by `bin/rip` as `bun --preload=<loader> src/cli/repl.js`, so
...
import { compile, CompileError, classifyCompleteness } from '../compiler.js';
import { tokenize, makeParserLexer } from '../lexer.js';
import { identifierRuns, isIdentifierName } from '../ident.js';
