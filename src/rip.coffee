...
class LALRGenerator
  ...
  generateModule: (options = {}) ->
    moduleName = options.moduleName or "parser"
    version = '0.5.0-jison-rip'; # require('./package.json').version
...
if require.main is module
  ...
  showHelp = ->
    ...
    Usage: coffee rip.coffee [options] [grammar-file]
    ...
    Examples:
      coffee rip.coffee grammar.coffee
      coffee rip.coffee --stats --verbose grammar.coffee
      coffee rip.coffee --generate --output parser.js grammar.coffee
      coffee rip.coffee --language json --output grammar.json grammar.coffee
  ...
  generateLanguagePack = (generator, language, outputFile) ->
    switch language.toLowerCase()
      when 'js', 'javascript'
        content = """
        // Generated by Rip LALR(1) Parser Generator
        module.exports = {
