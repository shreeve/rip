...
| **Runtime JS** | Prefer CDN-pinned `rip.js`; it contains the compiled `@rip-lang/app` package, while `/@rip/rip.js` from the checkout provides the same artifact during development |
