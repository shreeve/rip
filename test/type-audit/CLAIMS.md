...
A carrier is `fixture:symbol` — the fixture file and a symbol the gate verifies still exists in it. ABSENT is a ruled claim not yet carried: it paints red on purpose, the queue's memory, exactly like a parked production.
