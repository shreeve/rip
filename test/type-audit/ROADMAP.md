...
- **Rip-native negatives are pinned.** Reactive, components, and schema have no honest twin to derive from; their expectations are PINNED — code and position, reviewed measurements under the hover-pins discipline, gated on RULINGS.md like the hovers beside them.
