...
BANNER = `Usage: rip [options] path/to/script.rip [args]
...
export var run = function() {
  ...
  if ((!opts.doubleDashed) && (opts.arguments[1] === '--')) {
    printWarn(`rip was invoked with '--' as the second positional argument, which is
...
compilePath = function(source, topLevel, base) {
  ...
  if (stats.isDirectory()) {
    ...
    return results;
  } else if (topLevel || helpers.isRip(source)) {
    sources.push(source);
