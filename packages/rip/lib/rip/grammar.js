...
// The Rip parser is generated from this grammar file using a
// bottom-up parser generator. Rip has a powerful and expressive grammar
...
// easily express Rip's rich syntax, particularly its context-sensitive
...
grammar = {
  ...
  // Rip is the **Expression** -- everything that can be an expression
  ...
  // Rip has two different symbols for functions. `->` is for ordinary
  ...
  // In Rip, an object literal is simply a list of assignments.
  Object: [
  ...
  Operation: [
    ...
    // [The existential operator](https://rip.org/#existential-operator).
    o('Expression ?', function() {
