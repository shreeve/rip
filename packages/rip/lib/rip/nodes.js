...
// `nodes.rip` contains all of the node classes for the syntax tree. Most
...
// The **Scope** class regulates lexical scoping within Rip. As you
...
export var Base = (function() {
  ...
  class Base {
    ...
    // This is what `rip --nodes` prints out.
  ...
  // error messages that come from `nodes.rip` due to statements ending up
...
export var Block = (function() {
  ...
  class Block extends Base {
    ...
    compileComments(fragments) {
      ...
      for (fragmentIndex = j = 0, len1 = fragments.length; j < len1; fragmentIndex = ++j) {
        ...
        if (fragment.precedingComments) {
          ...
          // is the generated output JavaScript, and Rip always
    ...
    astProperties(o) {
      ...
      // for Rip to always know which it should be. The presence of an
      ...
      // then Rip can copy Node's algorithm.
  ...
  class Value extends Base {
    ...
    compileNode(o) {
      ...
      if (props.length && (this.base.cached != null)) {
        ...
        // `a(x = 5); b(-> x = 6)`
        // (see issue #4437, https://github.com/jashkenas/rip/issues/4437)
...
export var Code = (function() {
  ...
  class Code extends Base {
    ...
    // required per the ES2015 spec. If the Rip function definition had
...
export var While = (function() {
  //### While
    ...
    // A while loop, the only sort of low-level loop exposed by Rip. From
  ...
  class While extends Base {
    ...
    // The main difference from a JavaScript *while* is that the Rip
...
export var Op = (function() {
  ...
  // Rip operations into their JavaScript equivalents.
  class Op extends Base {
    ...
    //
    //     bin/rip -e 'console.log 50 < 65 > 10'
    //     true
    compileChain(o) {
  ...
  // The map of conversions from Rip to JavaScript symbols.
  CONVERSIONS = {
    '==': '===',
    '!=': '!==',
    'of': 'in',
...
export var For = (function() {
  //### For
    ...
    // Rip's replacement for the *for* loop is our array and object
  ...
  class For extends While {
    ...
    // Welcome to the hairiest method in all of Rip. Handles the inner
...
// Wherever in Rip 1 we might've inserted a `makeCode "#{@tab}"` to
