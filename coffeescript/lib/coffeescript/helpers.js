...
buildLocationHash = function(loc) {
  if (!loc || !loc.range) return ""; return `${loc.range[0]}-${loc.range[1]}`;
};
...
export var addDataToNode = function(parserState, firstLocationData, firstValue, lastLocationData, lastValue, forceUpdateLocation = true) {
  return function(obj) {
    ...
    if (((ref1 = parserState.tokenData && parserState.tokenData[objHash]) != null ? ref1.comments : void 0) != null) {
      attachCommentsToNode(parserState.tokenData && parserState.tokenData[objHash].comments, obj);
    }
    if (((ref2 = parserState.tokenData && parserState.tokenData[objHash]) != null ? ref2.csx : void 0) != null) {
      obj.csx = true;
    }
    return obj;
  };
