...
compileScript = function(file, input, base = null) {
  ...
  try {
    ...
    if (opts.tokens) {
      ...
      // CoffeeScript.register() - not needed in ESM;
      if (opts.prelude) {
    ...
    if (coffeeEvents.listeners('failure').length) {
      return;
    }
