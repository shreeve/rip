...
var FILE_EXTENSIONS, Lexer, base64encode, checkShebangLine, compile, getSourceMap, helpers, lexer, packageJson, parser, registerCompiled, withPrettyErrors;
...
exports.compile = compile = withPrettyErrors(function(code, options = {}) {
  ...
  if (options.header) {
    header = `Generated by Rip ${this.VERSION}`;
    js = `// ${header}\n${js}`;
  }
  if (generateSourceMap) {
