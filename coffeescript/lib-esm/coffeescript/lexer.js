...
import { count, starts, compact, repeat, merge, attachCommentsToNode, locationDataToString, throwSyntaxError, replaceUnicodeCodePointEscapes, flatten, parseNumber } from './helpers';
...
export const isUnassignable = isUnassignable;
