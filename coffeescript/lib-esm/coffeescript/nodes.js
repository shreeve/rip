...
import { compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, replaceUnicodeCodePointEscapes, isFunction, isPlainObject, isNumber, parseNumber } from './helpers';

  // `nodes.coffee` contains all of the node classes for the syntax tree. Most
  // nodes are created as the result of actions in the [grammar](grammar.html),
  // but some are created by other nodes as a method of code generation. To convert
  // the syntax tree into a string of JavaScript code, call `compile()` on the root.
var HEREGEX_OMIT, JS_FORBIDDEN, LEADING_BLANK_LINE, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, NEGATE, NO, SIMPLENUM, SIMPLE_STRING_OMIT, STRING_OMIT, Scope, SwitchCase, TAB, THIS, TRAILING_BLANK_LINE, UTILITIES, YES, astAsBlockIfNeeded, attachCommentsToNode, compact, del, emptyExpressionLocationData, ends, extractSameLineLocationDataFirst, extractSameLineLocationDataLast, flatten, fragmentsToText, greater, hasLineComments, indentInitial, isAstLocGreater, isFunction, isLiteralArguments, isLiteralThis, isLocationDataEndGreater, isLocationDataStartGreater, isNumber, isPlainObject, isUnassignable, lesser, locationDataToString, makeDelimitedLiteral, merge, moveComments, multident, parseNumber, replaceUnicodeCodePointEscapes, shouldCacheOrIsAssignable, sniffDirectives, some, starts, throwSyntaxError, unfoldSoak, unshiftAfterComments, utility, zeroWidthLocationDataFromEndLocation;
  indexOf = [].indexOf;
  splice = [].splice;
  slice1 = [].slice;
...
export const addDataToNode = addDataToNode;
...
export const CodeFragment = class CodeFragment {
...
// See Base#hoist.
export const HoistTarget = class HoistTarget extends Base {
...
export const Directive = class Directive extends Base {
  constructor(value1) {
    super();
    this.value = value1;
  }
...
export const NumberLiteral = class NumberLiteral extends Literal {
...
export const InfinityLiteral = class InfinityLiteral extends NumberLiteral {
...
export const NaNLiteral = class NaNLiteral extends NumberLiteral {
  constructor() {
    super('NaN');
  }
...
export const StringLiteral = class StringLiteral extends Literal {
...
export const PassthroughLiteral = class PassthroughLiteral extends Literal {
...
export const ComputedPropertyName = class ComputedPropertyName extends PropertyName {
  compileNode(o) {
...
export const ThisLiteral = class ThisLiteral extends Literal {
  constructor(value) {
    super('this');
...
export const UndefinedLiteral = class UndefinedLiteral extends Literal {
  constructor() {
    super('undefined');
  }
...
export const NullLiteral = class NullLiteral extends Literal {
  constructor() {
    super('null');
  }
...
export const BooleanLiteral = class BooleanLiteral extends Literal {
...
export const DefaultLiteral = class DefaultLiteral extends Literal {
  astType() {
    return 'Identifier';
  }
...
export const HereComment = class HereComment extends Base {
  constructor({
      content,
      newLine,
      unshift,
...
export const LineComment = class LineComment extends Base {
  constructor({
      content,
      newLine,
      unshift,
...
//### TaggedTemplateCall
export const TaggedTemplateCall = class TaggedTemplateCall extends Call {
...
export const RegexIndex = (function() {
...
export const ObjectProperty = class ObjectProperty extends Base {
...
export const ImportDeclaration = class ImportDeclaration extends ModuleDeclaration {
  compileNode(o) {
    var code, ref1;;
...
export const ExportDeclaration = class ExportDeclaration extends ModuleDeclaration {
  compileNode(o) {
    var code, ref1;;
...
export const ExportNamedDeclaration = class ExportNamedDeclaration extends ExportDeclaration {
  astProperties(o) {
...
export const ExportDefaultDeclaration = class ExportDefaultDeclaration extends ExportDeclaration {
  astProperties(o) {
    return {
...
export const ExportAllDeclaration = class ExportAllDeclaration extends ExportDeclaration {
  astProperties(o) {
    return {
      source: this.source.ast(o),
      assertions: this.astAssertions(o),
...
export const ImportSpecifierList = class ImportSpecifierList extends ModuleSpecifierList {};

export const ExportSpecifierList = class ExportSpecifierList extends ModuleSpecifierList {};
...
export const ImportSpecifier = class ImportSpecifier extends ModuleSpecifier {
...
export const ImportDefaultSpecifier = class ImportDefaultSpecifier extends ImportSpecifier {
  astProperties(o) {
    return {
...
export const ImportNamespaceSpecifier = class ImportNamespaceSpecifier extends ImportSpecifier {
  astProperties(o) {
    return {
...
export const ExportSpecifier = class ExportSpecifier extends ModuleSpecifier {
...
export const DynamicImport = class DynamicImport extends Base {
  compileNode() {
...
export const DynamicImportCall = class DynamicImportCall extends Call {
  compileNode(o) {
    this.checkArguments();
    return super.compileNode(o);
  }
...
//### FuncGlyph
export const FuncGlyph = class FuncGlyph extends Base {
  constructor(glyph) {
    super();
    this.glyph = glyph;
  }
...
export const TemplateElement = class TemplateElement extends Base {
  constructor(value1, {
      tail: tail1
    } = {}) {
    super();
...
export const EmptyInterpolation = class EmptyInterpolation extends Base {
  constructor() {
    super();
  }
