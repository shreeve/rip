...
module.export const VERSION = CoffeeScript.VERSION;

module.export const FILE_EXTENSIONS = CoffeeScript.FILE_EXTENSIONS;

module.export const helpers = CoffeeScript.helpers;

module.export const registerCompiled = CoffeeScript.registerCompiled;

module.export const compile = CoffeeScript.compile;

module.export const tokens = CoffeeScript.tokens;

module.export const nodes = CoffeeScript.nodes;

module.export const register = CoffeeScript.register;

module.export const eval = CoffeeScript.eval;

module.export const run = CoffeeScript.run;

module.export const transpile = CoffeeScript.transpile;

module.export const patchStackTrace = CoffeeScript.patchStackTrace;

module.export const _compileRawFileContent = CoffeeScript._compileRawFileContent;

module.export const _compileFile = CoffeeScript._compileFile;
